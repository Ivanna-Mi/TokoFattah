...
<div class="container-fluid" style="margin: 0;padding: 0;">
	<div class="image" style="margin-top: -21px">
		<img src="image/home/logo.jpg" style="width: 50%;  height: 700px;">
	</div>
</div>
</center>
<br>
...
<div class="container">
		...
		<h4 class="text-center" style="font-family: arial; padding-top: 10px; padding-bottom: 10px; font-style: italic; line-height: 29px; border-top: 2px solid #08b30b; border-bottom: 2px solid #08b30b;">FATTAH adalah salah satu toko oleh-oleh haji umroh. Didirikan pada tahun 2019,Produk kami sehat, bergizi, dan terjangkau oleh semua orang.</h4>


	<h2 style=" width: 100%; border-bottom: 4px solid #08b30b; margin-top: 80px;"><b>Produk Kami</b></h2>
